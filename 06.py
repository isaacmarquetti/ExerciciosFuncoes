...
esse cálculo para novos valores de entrada todas as vezes
que desejar.
"""


def converter_horario(h, min):
    if h > 12:
        hora_pm = h - 12
        return f'{hora_pm}:{min} P.M.'
    else:
        hora_am = h
        return f'{hora_am}:{min} A.M.'
...
while True:
    ...
    print(converter_horario(hora, minuto))
